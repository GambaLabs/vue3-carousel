...
(function (global, factory) {
  ...
  const useElementRect = (elementRef) => {
      ...
      const width = vue.ref(((_a = elementRef.value) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect().width) || 0);
      const height = vue.ref(((_b = elementRef.value) === null || _b === void 0 ? void 0 : _b.getBoundingClientRect().height) || 0);
      const top = vue.ref(((_c = elementRef.value) === null || _c === void 0 ? void 0 : _c.getBoundingClientRect().top) || 0);
      const left = vue.ref(((_d = elementRef.value) === null || _d === void 0 ? void 0 : _d.getBoundingClientRect().left) || 0);
      const bottom = vue.ref(((_e = elementRef.value) === null || _e === void 0 ? void 0 : _e.getBoundingClientRect().bottom) || 0);
      const right = vue.ref(((_f = elementRef.value) === null || _f === void 0 ? void 0 : _f.getBoundingClientRect().right) || 0);
      const ready = vue.ref(!!elementRef.value);
      let observer = null;
      ...
      const stopWatchElement = vue.watch(() => elementRef.value, (element) => {
          cleanup();
          if (element) {
